      ...
      <div className="debrief-grid">
        <div>
          <section className="b2b-card">
            <h2 className="b2b-card__title">Debrief</h2>
            <ol className="debrief-steps">
              <li><b>1 · Open</b> — “How did you feel during the session?”</li>
              <li><b>2 · Observations</b> — share insights from your notes</li>
              <li><b>3 · Next step</b> — co-define the next goal</li>
            </ol>

            <label className="b2b-label">Observations (pre-filled from rapid notes)</label>
            <textarea className="b2b-textarea" rows={4} value={observations} onChange={(e) => setObservations(e.target.value)} />

            <label className="b2b-label">Next session goal</label>
            <input className="b2b-input" value={nextGoal} onChange={(e) => setNextGoal(e.target.value)} placeholder="e.g. Consolidate sleep routine" />

            <label className="b2b-label">Inter-session assignment (B2C)</label>
            <input className="b2b-input" value={assignment} onChange={(e) => setAssignment(e.target.value)} placeholder="e.g. 3× GL-ANX Quick / week" />
          </section>
        </div>
        ...
        <div>
          ...
          <p className="b2b-sub" style={{ marginTop: 8, textAlign: 'center' }}>Saves ~10 min of documentation.</p>
        </div>
      </div>
    </div>
  )
